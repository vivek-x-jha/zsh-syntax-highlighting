...
ZSH_HIGHLIGHT_STYLES[command-substitution-unquoted]=fg=2
ZSH_HIGHLIGHT_STYLES[command-substitution-quoted]=fg=2
ZSH_HIGHLIGHT_STYLES[command-substitution-delimiter]=fg=2
ZSH_HIGHLIGHT_STYLES[command-substitution-delimiter-unquoted]=fg=2
...
ZSH_HIGHLIGHT_STYLES[back-dollar-quoted-argument]=fg=2
ZSH_HIGHLIGHT_STYLES[assign]=fg=7
ZSH_HIGHLIGHT_STYLES[redirection]=fg=7
ZSH_HIGHLIGHT_STYLES[comment]=fg=8
ZSH_HIGHLIGHT_STYLES[named-fd]=fg=3
ZSH_HIGHLIGHT_STYLES[numeric-fd]=fg=3
ZSH_HIGHLIGHT_STYLES[arg0]=fg=225
